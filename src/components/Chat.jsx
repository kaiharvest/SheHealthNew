...
const ChatApp = () => {
    ...
    const messages = [
        ...
        },
        {
            id: 5,
            sender: 'doctor',
            text: 'Baik, Anis. Saya mengerti keluhan Anda. Apakah intensitas nyeri kepala tersebut bertambah dari waktu ke waktu? Dan apakah ada aktivitas atau makanan tertentu yang memicu sakit kepala tersebut?',
            time: '',
            avatar: '👨‍⚕️'
        }
    ];
