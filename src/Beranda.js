    ...
    <div className="font-poppins">
      ...
      <section className="bg-white pt-40 pb-40">
        <div className="container mx-auto px-6 md:px-10 flex flex-col-reverse md:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            <h2 className="text-pink-400 text-5xl font-semibold mb-2">Teman Sehat Perempuan</h2>
            <h1 className="text-4xl font-bold mb-6">di setiap tahap kehidupan.</h1>
            ...
            <button className="bg-pink-400 text-white px-10 py-4 rounded-full hover:bg-pink-500 transition">
              Konsultasi
            </button>
          </div>
          ...
          <div className="flex-1 relative">
            <img src="/icons/hati.svg" alt="Heart Icon" className="absolute -top-5 left-36 w-20 z-30" />
            <img src="/icons/rumah-sakit.svg" alt="Hospital Icon" className="absolute top-10 right-16 w-16 z-30" />
            <img src="/icons/logo.svg" alt="Shield Icon" className="absolute -bottom-20 right-24 w-24 z-30" />
            <img src="/icons/Card Item.svg" alt="Plus Icon" className="absolute bottom-1 left-16 w-28 md:w-56 z-30" />
      ...
      <section className="pt-36 pb-40">
        <div className="container mx-auto px-6 md:px-10 text-center">
          <h2 className="text-5xl font-bold text-black mb-6">Mengapa memilih kami?</h2>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-8">
            {[
              ...
              <div
                key={idx}
                className="p-8 w-80 border border-gray-300 rounded-lg bg-white transition-transform duration-300 hover:scale-105 hover:shadow-lg"
              >
                <img src="/icons/content2.png" alt="Icon" className="w-24 mb-6 mx-auto -mt- -ml-8" />
      ...
      <section className="pt-24 pb-40 bg-pink-50">
        <div className="container mx-auto px-6 md:px-10 text-center">
          <h2 className="text-5xl font-bold text-black mb-10">Layanan Tersedia</h2>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 justify-center">
            {[
              ...
              <div key={idx} className="flex flex-col items-center">
                <div className="w-32 h-32 border-2 rounded-full flex items-center justify-center mb-4">
                  <img src={item.icon} alt={item.label} className="w-14" />
                </div>
                <p className="text-lg font-medium text-black text-center">{item.label}</p>
              </div>
            ))}
          </div>
        </div>
